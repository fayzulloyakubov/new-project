...
?>
<div class="change-executor-view">
    <?php if(!Yii::$app->request->isAjax){?>
    <div class="pull-right" style="margin-bottom: 15px;">
        <?php if (Yii::$app->user->can('change-executor/update')): ?>
            <?php  if ($model->status < $model::STATUS_SAVED): ?>
                <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
            <?php endif; ?>
        <?php endif; ?>
        <?php if (Yii::$app->user->can('change-executor/delete')): ?>
            <?php  if ($model->status < $model::STATUS_SAVED): ?>
    ...
    <?= DetailView::widget([
        ...
        'attributes' => [
            ...
            [
                'attribute' => 'old_executor_date',
            ],
            [
                'attribute' => 'new_executor_date',
            ],
            [
                'attribute' => 'change_executor_reason',
            ],
            [
                'attribute' => 'add_info',
            ],
