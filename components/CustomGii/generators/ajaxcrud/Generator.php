...
namespace app\components\CustomGii\generators\ajaxcrud;
...
class Generator extends \app\components\CustomGii\Generator
{
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['module','modelClass', 'controllerClass', 'baseControllerClass', 'indexWidgetType'], 'required'],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            'module' => 'Modul nomini tanlang',
            'crudname' => 'Crud nomini o`zgartirish',
    ...
    public function hints()
    {
        return array_merge(parent::hints(), [
            'module' => 'CRUD shu yerda yozilgan modulda yaratiladi. M-n <code>base</code> tanlasangiz CRUD <code>\app\modules\base</code>da yaratiladi',
            ...
            'crudname' => 'CRUD nomi shu yerda yozilgan nom bilan yaratiladi',
    ...
    public function generate()
    {
        ...
        foreach (scandir($templatePath) as $file) {
            if (empty($this->searchModelClass) && $file === '_search_report_mato.php') {
                continue;
            }
    ...
    public function generateActiveField($attribute)
    {
        ...
        if ($column->name === 'status' || $column->name === 'created_by' || $column->name === 'created_at' || $column->name === 'updated_at') {
            return false;
        }
