...
namespace app\components\CustomGii;
 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'app\components\CustomGii\Hrm'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * {@inheritdoc}
     */
    public $controllerNamespace = 'app\components\CustomGii\controllers';
    /**
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'app\components\CustomGii\console\GenerateController',
    ...
    {
        return [
            'model' => ['class' => 'app\components\CustomGii\generators\model\Generator'],
            'crud' => ['class' => 'app\components\CustomGii\generators\crud\Generator'],
            'ajaxcrud' => ['class' => 'app\components\CustomGii\generators\ajaxcrud\Generator'],
            'controller' => ['class' => 'app\components\CustomGii\generators\controller\Generator'],
            'form' => ['class' => 'app\components\CustomGii\generators\form\Generator'],
            'module' => ['class' => 'app\components\CustomGii\generators\module\Generator'],
            'extension' => ['class' => 'app\components\CustomGii\generators\extension\Generator'],
        ];
    }
