...
use app\components\CustomTreeView\CustomTreeView as TreeView;
...
<?php if (!$node->isNewRecord || !empty($parentKey)): ?>
     ...
     */
    ?>
    <div class="kv-detail-heading no-print">
        <?php if (empty($inputOpts['disabled']) || ($isAdmin && $showFormButtons)): ?>
            <div class="float-right pull-right">
                ...
                <?= Html::button(
                    ArrayHelper::getValue($nodeViewButtonLabels, 'print', $printTitle),
                    ['class' => 'btn btn-success button-print', 'title' => $printTitle]
                ) ?>
            </div>
        <?php endif; ?>
